...
in_path = OUT / 'results' / f'kinematic_estimates_{DATASET_KEY}_N{N_RUNS}_shots{N_SHOTS}.json'
...
out_path = OUT / 'results' / f'beta_fits_{DATASET_KEY}_N{N_RUNS}_shots{N_SHOTS}.json'
